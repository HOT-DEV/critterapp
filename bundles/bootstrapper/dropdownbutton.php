...
class DropdownButton 
{
	...
	*/
	public static function __callStatic($method, $parameters)
	{
		...
		{
			throw new \Exception("DropdownButton list is required parameter should be an array of links");
		}
		...
		if(isset($parameters[2]))
		{
			...
			{
				throw new \Exception("DropdownButton attributes parameter should be an array of attributes");
			}
		}	
		...
		if(isset($parameters[3]))
		{
			...
			{
				throw new \Exception("DropdownButton right parameter should be a bool");
			}
		}	
		...
		if(isset($parameters[4]))
		{
			...
			{
				throw new \Exception("DropdownButton dropup parameter should be a bool");
			}
		}	
